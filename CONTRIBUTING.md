...
* In Github, fork `https://github.com/cloudescape/licentia` to your own account
* Get the package using "go get": `go get github.com/cloudescape/licentia`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/cloudescape/licentia`
* Add a git remote pointing to your own fork: `git remote add downstream git@github.com:<your_account>/licentia.git`
